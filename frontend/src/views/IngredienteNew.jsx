...
function IngredienteNew() {
    ...
    async function postIngrediente(e) {
        e.preventDefault();
        ...
        try {
            const response = await fetch(`${host}/ingredientes`, opciones);
            ...
            setMsg({ text: 'Ingrediente creado exitosamente', type: 'success' });
            setShowAlert(true);
            setTimeout(() => {
    ...
    return (
        <>
            ...
            />
            <MainH1>Crear Ingrediente</MainH1>
            <form onSubmit={postIngrediente} className='longForm'>
                <FormInput
                    label="Nombre"
                    htmlFor="nombre"
                    type="text"
