...
function RecetaUpdate() {
    ...
    function validateField(name, value) {
        switch (name) {
            ...
            case 'dificultad':
                ...
                return '';
            case 'imagen':
                if (!imagenFile && !(receta.imagen && receta.imagen.startsWith('uploads/'))) {
                    return 'Debe seleccionar una imagen (archivo)';
                }
                return '';
            default:
                return '';
    ...
    useEffect(() => {
        ...
        async function getRecetaById() {
            try {
                ...
                if (!response.ok) {
                    setMsg({ text: 'Error al obtener la receta', type: 'error' });
                    setShowAlert(true);
                    return;
                }
                ...
                setReceta({
                    ...
                    tiempoCoccion: data.tiempoCoccion ? String(data.tiempoCoccion) : '',
    ...
    function handlerChange(e) {
        ...
        if (name === 'ingredientes' && type === 'checkbox') {
            ...
            setReceta(prev => ({
                ...prev,
                imagen: files[0] ? files[0].name : prev.imagen
            }));
            setErrors(prev => ({
                ...prev,
    ...
    async function putReceta(e) {
        ...
        try {
            ...
            setMsg({ text: 'Receta actualizada exitosamente', type: 'success' });
            setShowAlert(true);
            setTimeout(() => {
                navigate('/recetas');
            }, 1200);
    ...
    return (
        <>
            ...
            />
            <MainH1>Actualizar Receta</MainH1>
            <form onSubmit={putReceta} className='longForm' encType="multipart/form-data">
                <FormInput
                    label="Nombre"
                    htmlFor="nombre"
                    type="text"
                ...
                <div className="formFieldContainer">
                    ...
                    <input
                        ...
                        onChange={handlerChange}
                    />
                    {receta.imagen && receta.imagen.startsWith('uploads/') && !imagenFile && (
                        <div>
